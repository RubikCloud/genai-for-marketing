...
#         "lealprodcns",
#         "gai_marketing",
#         "projects/lealprodcns/locations/us-central1/tagTemplates/llmcdptemplate",
#         "llmcdptemplate",
#     )
# # Copyright 2023 Google LLC
# #
...
#     #     if response.template == "projects/lealprodcns/locations/us-central1/tagTemplates/llmcdptemplate":
...
#     )
#
# # "bq_tag_generation.tag_metadata_from_bq(\"${var.project_id}\",\"${var.dataset_name}\",\"${google_data_catalog_tag_template.tag_template.name}\",\"${google_data_catalog_tag_template.tag_template.tag_template_id}\")'"
#
#
# if __name__ == "__main__":
#     print("runnin")
